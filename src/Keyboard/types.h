...
const int FUNCTION_FACE[NUM_ROWS][NUM_COLS] = {
  ...
  {0,0,0,0,0,0,0,KEY_PAGE_DOWN,KEY_UP,KEY_PAGE_UP,KEY_PRINTSCREEN,0,},
  {0,0,0,0,0,0,KEY_HOME,KEY_LEFT,KEY_DOWN,KEY_RIGHT,0,0,},
...
const int RAISE_FACE[NUM_ROWS][NUM_COLS] = {
  {0,KEYPAD_7,KEYPAD_8,KEYPAD_9,KEYPAD_MINUS,0,0,0,0,0,0,0,},
